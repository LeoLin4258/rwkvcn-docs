export const chartData = [
    ...
    },
    {
        ...
        labels: ['Average', 'ao3\nenglish', 'bbc\nnews', 'wikipedia\nenglish', 'arxiv\ncomputer\nscience', 'arxiv\nphysics', 'github\ncpp', 'github\npython'],
        datasets: [
            { label: 'Qwen2-1.5B', data: [8.457, 11.777, 9.443, 9.876, 8.751, 9.323, 5.019, 5.009] },
            { label: 'Index-1.9B', data: [8.491, 11.662, 9.495, 9.521, 8.546, 8.717, 5.533, 5.963] },
            { label: 'stablelm-2-1_6b', data: [8.531, 11.563, 9.211, 9.381, 8.791, 9.248, 5.646, 5.875] },
            { label: 'Rene-v0.1-1.3b-pytorch', data: [8.559, 11.621, 9.199, 9.839, 8.653, 9.086, 5.542, 5.973] },
            { label: 'RWKV-6-World-1B6-v2.1', data: [8.676, 11.240, 9.546, 9.595, 8.842, 9.145, 6.002, 6.364] },
            { label: 'RWKV-5-World-1B5-v2', data: [8.826, 11.391, 9.741, 9.795, 8.972, 9.256, 6.127, 6.500] },
            { label: 'mamba2-1.3b', data: [8.857, 11.776, 9.693, 10.202, 8.939, 8.864, 5.899, 6.623] },
            { label: 'mamba-1.4b-hf', data: [8.966, 11.845, 9.770, 10.320, 9.082, 8.986, 6.009, 6.748] },
            { label: 'TinyLlama-1.1B-intermediate-3T', data: [8.988, 12.399, 9.742, 10.004, 9.300, 9.779, 5.642, 6.047] },
            { label: 'Qwen1.5-1.8B', data: [9.143, 12.452, 9.894, 10.609, 9.138, 9.717, 5.930, 6.261] },
            { label: 'RWKV-4-World-1.5B-v1', data: [9.188, 11.465, 9.943, 10.109, 9.573, 9.964, 6.393, 6.869] },
            { label: 'OLMo-1B-hf', data: [9.197, 12.137, 9.605, 10.342, 9.259, 9.909, 6.310, 6.817] },
            { label: 'Qwen-1_8B', data: [9.326, 12.595, 9.994, 10.768, 9.317, 9.960, 6.164, 6.483] },
            { label: 'pythia-1.4b-v0', data: [9.333, 12.323, 10.129, 10.780, 9.320, 9.333, 6.342, 7.105] },
            { label: 'RWKV-4-Pile-1B5', data: [9.460, 12.214, 10.162, 10.884, 9.594, 9.484, 6.556, 7.328] },
            { label: 'h2o-danube-1.8b-base', data: [9.719, 11.647, 9.184, 9.515, 9.338, 10.038, 9.286, 9.023] },
            { label: 'Sheared-LLaMA-1.3B', data: [9.784, 12.192, 9.698, 10.301, 9.683, 10.382, 7.893, 8.339] },
            { label: 'bloom-1b7', data: [9.820, 13.430, 10.917, 11.413, 9.490, 9.851, 6.377, 7.262] },
            { label: 'OpenELM-1_1B', data: [10.193, 14.926, 10.581, 10.518, 9.490, 10.011, 7.875, 7.948] },
            { label: 'TransNormerLLM-1B', data: [10.448, 12.893, 10.497, 11.104, 10.670, 11.361, 7.729, 8.883] },
            { label: 'phi-1_5', data: [10.498, 13.447, 11.084, 13.506, 9.994, 11.724, 7.306, 6.425] },
            { label: 'falcon-rw-1b', data: [12.117, 12.062, 9.561, 10.490, 9.631, 10.524, 16.314, 16.238] }
        ]
    },
    {
        name: 'RULER-Datas',
