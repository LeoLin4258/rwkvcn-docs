---
title: PiSSA 微调教程
description: PiSSA 微调是一种参数高效微调方法，通过选择性更新RWKV模型部分参数（例如 LoRA 或 Adapter 层）来保持模型性能，同时避免对整个模型进行全面更新，从而提升训练效率。
keywords: [RWKV PiSSA 微调, PiSSA 微调教程, PiSSA 微调方法, PiSSA 微调框架, PiSSA 微调效果]
---
