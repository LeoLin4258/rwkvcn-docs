...
- [Seikaijyu/rwkv7-g1-1.5b-Lonely-Neko](https://huggingface.co/Seikaijyu/rwkv7-g1-1.5b-Lonely-Neko)：基于 RWKV-7 G1 1.5B 模型微调的猫娘模型，拥有较为优秀的单角色扮演能力
- [keepzmy/RWKV-V7-Soothe](https://huggingface.co/keepzmy/RWKV-V7-Soothe)：基于 RWKV-7 G1 2.9B 模型微调的心理咨询师模型
