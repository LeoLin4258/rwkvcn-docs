...
![RWKV-v2-RNN-Architecture](./imgs/RWKV-Architecture/RWKV-v2-RNN-Architecture.png)
...
![RWKV-V4 语言建模的架构](./imgs/RWKV-Architecture/rwkv-architecture-for-language-modeling.png)
...
![RWKV 语言建模的隐藏状态流动图解](./imgs/RWKV-Architecture/rwkv-architecture-for-language-modeling.png)
