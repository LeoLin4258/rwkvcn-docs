...
- [RWKV-8 系列之 ROSA（RWKV Online Suffix Automaton） 机制：开启未来之路](https://www.rwkv.cn/news/read?id=20251029)
</CallOut>
...
| 1.5B 模型 | ✅ 已发布 | ✅ 已发布| ✅ [已发布](https://modelscope.cn/models/Blink_DL/rwkv-6-world/file/view/master/RWKV-x060-World-1B6-v2.1-20240328-ctx4096.pth) |✅ [已发布](https://modelscope.cn/models/Blink_DL/rwkv-7-world/files) | ✅ [已发布](https://modelscope.cn/models/Blink_DL/rwkv7-g1/file/view/master/rwkv7-g1a3-1.5b-20251015-ctx8192.pth?status=2) |
| 3B 模型 | ✅ 已发布 | ✅ 已发布 | ✅ [已发布](https://modelscope.cn/models/Blink_DL/rwkv-6-world/file/view/master/RWKV-x060-World-1B6-v2.1-20240328-ctx4096.pth) |✅ [已发布](https://modelscope.cn/models/Blink_DL/rwkv-7-world/files) | ✅ [已发布](https://modelscope.cn/models/Blink_DL/rwkv7-g1/file/view/master/rwkv7-g1a-2.9b-20250924-ctx4096.pth?status=2) |
| 7B 模型 | ✅ 已发布 | ✅ 已发布| ✅ [已发布](https://modelscope.cn/models/Blink_DL/rwkv-6-world/file/view/master/RWKV-x060-World-7B-v3-20241112-ctx4096.pth) |**❌ 无计划** | ✅ [已发布](https://modelscope.cn/models/Blink_DL/rwkv7-g1/file/view/master/rwkv7-g0a2-7.2b-20251005-ctx4096.pth?status=2) |
| 14B 模型 | ✅ 已发布 | ❌ 无计划 | ✅ [已发布](https://modelscope.cn/models/Blink_DL/rwkv-6-world/file/view/master/RWKV-x060-World-14B-v2.1-20240719-ctx4096.pth) |**❌ 无计划** | ✅ [已发布](https://modelscope.cn/models/Blink_DL/rwkv7-g1/file/view/master/rwkv7-g0a3-13.3b-20251031-ctx4096.pth?status=2) |
...
- 如果您的显存大于 16GB ，推荐使用量化后的 [RWKV7-G0a3 13.3B 模型](https://modelscope.cn/models/RWKV/rwkv7-g1/files)，这是目前最强大的 RWKV 模型，拥有最强的推理、代码和数学能力
- 如果您的显存位于 8GB 到 16GB 之间，请使用 [RWKV7-G0a3 7.2B 模型](https://modelscope.cn/models/RWKV/rwkv7-g1/files) 
- 如果您的显存小于 8GB ，请使用 [RWKV7-G1a 2.9B 模型](https://modelscope.cn/models/RWKV/rwkv7-g1/files)
