...
| **g1b / g0a2 / g1a3** | **训练数据的版本**，数据质量排序：G1b > G1a3 > G1a2 > G1a > G1 > G0a2 > G0 。RWKV7-G1a 模型是在 RWKV7-G1 模型的基础上继续训练了 1T 优质推理和指令数据，RWKV7-G1a2 则是在 RWKV7-G1a 模型的基础上继续添加数据训练，以此类推 |
...
- **7B 及以下参数的模型**：请使用 [RWKV7-G0a2 7.2B 模型](https://modelscope.cn/models/RWKV/rwkv7-g1/files) 或 [RWKV7-G1a 2.9B 模型](https://modelscope.cn/models/RWKV/rwkv7-g1/files)，得益于最新的架构设计和最新数据集，RWKV7-G1 模型有较强的**推理、代码和数学能力**，在所有任务上的表现都比过去的模型更好
