...
| 7B 模型 | ✅ 已发布 | ✅ 已发布| ✅ [已发布](https://modelscope.cn/models/Blink_DL/rwkv-6-world/file/view/master/RWKV-x060-World-7B-v3-20241112-ctx4096.pth) |**❌ 无计划** | ⚙️ **训练中** |
| 14B 模型 | ✅ 已发布 | ❌ 无计划 | ✅ [已发布](https://modelscope.cn/models/Blink_DL/rwkv-6-world/file/view/master/RWKV-x060-World-14B-v2.1-20240719-ctx4096.pth) |**❌ 无计划** | 📅 **计划训练** |
...
- **7B 及以下参数的模型**：请使用 [RWKV7-G1 2.9B 模型](https://modelscope.cn/models/RWKV/rwkv7-g1/files)，得益于最新的架构设计和最新的 World v3.5 数据集（总数据为 5.16T tokens），RWKV7-G1 模型有较强的**推理、代码和数学能力**，在所有任务上的表现都比过去的模型更好
- **7B 以上参数的模型**：由于 RWKV7-G1 7B 及更大的模型正在训练中，推荐使用 [RWKV-6-World-14B-V2.1](https://hf-mirror.com/BlinkDL/rwkv-6-world/blob/main/RWKV-x060-World-14B-v2.1-20240719-ctx4096.pth) 模型
