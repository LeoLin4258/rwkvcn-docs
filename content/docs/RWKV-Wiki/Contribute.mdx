---
title: 为 RWKV 作贡献
description: 加入RWKV社区，帮助我们改进文档、试用模型和应用、开发应用、进行基准测试、提供数据集、多模态研究等。
keywords: [加入rwkv社区, 参与RWKV社区, RWKV社区贡献, RWKV社区贡献方向, RWKV社区贡献指南]
---
...
在 RWKV 技术研发群（QQ 群 325154699）中讨论并分享您的 RWKV 应用。
...
在 RWKV 技术研发群（QQ 群 325154699）中讨论并分享您关于 RWKV 的基准测试结果。
...
可以在 RWKV discord 的 [#dataset channel](https://discord.gg/uMpzuDwcu5) 频道或 RWKV技术研发群（QQ 群 325154699）中参与此工作。
...
RWKV 现有的多模态等学术研究可以在 [RWKV 生态](./Links) 中找到：
</CallOut>
