...
- [RWKV7-G1x-models](https://huggingface.co/BlinkDL/rwkv7-g1)：RWKV 官方 Hugging Face 仓库，提供 RWKV-7 G1 系列模型
- [Albatross](https://github.com/BlinkDL/Albatross)：Albatross 推理服务端，支持 RWKV 模型 API 与多实例并发推理
...
- **(推荐)** [RWKV-PEFT](https://github.com/Joluck/RWKV-PEFT) ：RWKV 高效微调仓库，主打 LoRA、MiSS、State 等方法
- [RWKV-PEFT-Simple](https://github.com/Seikaijyu/RWKV-PEFT-Simple)：RWKV-PEFT 的简化版本，提供便捷脚本和微调说明
- **（可能过时）**[RWKV-LM-RLHF](https://github.com/OpenMOSE/RWKV-LM-RLHF)：RWKV 强化学习（RLHF）工具包，含 SFT、对齐（DPO、ORPO）等
...
- [rwkv.cpp](https://github.com/RWKV/rwkv.cpp)：在 CPU 与 GPU 上推理 RWKV 模型，支持 FP16、INT4、INT5 和 INT8 量化，且支持 cuBLAS 加速路径
...
- [rwkv-mobile](https://github.com/MollySophia/rwkv-mobile)：面向移动端的 RWKV 推理运行时，支持多端部署场景
...
- [llama.cpp](https://github.com/ggml-org/llama.cpp)：通用大模型推理框架，支持 RWKV 模型的加速部署与调用
...
- [rwkv_lightning](https://github.com/RWKV-Vibe/rwkv_lightning)：基于 Albatross 的 RWKV 批量推理服务，支持 CUDA 与 ROCm，并提供 REST API
- [RWKV APP](https://github.com/RWKV-APP/RWKV_APP)：面向桌面环境的 RWKV 工具集合，提供推理与交互示例
- **（中文，推荐）**  [RWKV runner](https://github.com/josStorer/RWKV-Runner)：RWKV Runner 是 RWKV 模型的管理和启动工具，带用户友好的 GUI 界面，支持训练和推理
- **（中文，推荐）** [AI00 RWKV server](https://github.com/Ai00-X/ai00_server)：Ai00 Server 是基于 web-rwkv 推理引擎的 RWKV 模型**推理 API 服务器**
...
- [LocalAI](https://github.com/mudler/LocalAI)：开源 OpenAI 替代品，支持 RWKV
