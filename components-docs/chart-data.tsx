...
export const chartData = [
    ...
    },
    {
        ...
        datasets: [
            ...
            { label: "RWKV-x070-World-1.5B-v3-20250127-ctx4096", "data": [8.16,10.932,9.337,8.972,8.25,8.77,5.288,5.571] },
            { label: "Llama-3.2-1B", "data": [8.225,11.693,9.343,9.066,8.365,8.762,5.16,5.184] },
            { label: "SmolLM2-1.7B", "data": [8.227,11.204,9.396,9.459,8.382,9.041,4.937,5.172] },
            { label: "stablelm-2-1_6b", "data": [8.338,11.423,9.243,9.057,8.579,9.076,5.45,5.535] },
            { label: "RWKV-x060-World-1B6-v2.1-20240328-ctx4096", "data": [8.491,11.094,9.569,9.302,8.619,8.997,5.798,6.061] },
            { label: "RWKV-5-World-1B5-v2-20231025-ctx4096", "data": [8.64,11.247,9.746,9.499,8.765,9.106,5.918,6.196] },
            ...
            { label: "Zamba2-1.2B", "data": [8.83,11.392,9.382,9.263,8.571,9.209,7.082,6.914] },
            { label: "SmolLM-1.7B", "data": [8.877,12.684,9.847,9.89,8.384,9.024,6.552,5.757] },
            { label: "gemma-3-1b-pt", "data": [8.903,12.188,9.364,9.597,8.874,9.559,6.591,6.15] },
            { label: "MobileLLM-1B", "data": [8.972,11.863,9.349,9.432,9.028,9.566,6.531,7.033] },
            { label: "RWKV-4-World-1.5B-v1-fixed-20230612-ctx4096", "data": [8.999,11.334,10,9.821,9.344,9.797,6.158,6.539] },
            { label: "pythia-1.4b-v0", "data": [9.154,12.192,10.2,10.429,9.122,9.198,6.149,6.788] },
            { label: "Falcon3-1B-Base", "data": [9.445,13.039,10.448,10.75,8.604,9.2,7.155,6.919] }
        ]
    },
    {
        name: 'RULER-Datas',
