...
<Tabs items={[' 条形图 ', ' 原始数据 ']}>
  <Tabs.Tab> 
    <LineChart name="RULER-Datas" seriesFilter={(series) => series.slice(0, 3)} />
  </Tabs.Tab>
  <Tabs.Tab> 
...
<Tabs items={[' 条形图 ', ' 原始数据 ']}>
  <Tabs.Tab> 
    <LineChart name="RULER-Datas" seriesFilter={(series) => series.slice(3, 6)} />
  </Tabs.Tab>
  <Tabs.Tab> 
...
<Tabs items={[' 条形图 ', ' 原始数据 ']}>
  <Tabs.Tab> 
    <LineChart name="RULER-Datas" seriesFilter={(series) => series.slice(6, 8)} />
  </Tabs.Tab>
  <Tabs.Tab> 
...
<Tabs items={[' 条形图 ', ' 原始数据 ']}>
  <Tabs.Tab>
    <LineChart name="RULER-Datas" seriesFilter={(series) => series.slice(8, 9)} />
  </Tabs.Tab>
  <Tabs.Tab>
    | 模型 | 多跳跟踪 |
    |------|----------|
...
<Tabs items={[' 条形图 ', ' 原始数据 ']}>
  <Tabs.Tab> 
    <LineChart name="RULER-Datas" seriesFilter={(series) => series.slice(9, 11)} />
  </Tabs.Tab>
  <Tabs.Tab> 
...
<Tabs items={[' 条形图 ', ' 原始数据 ']}>
  <Tabs.Tab> 
    <LineChart name="RULER-Datas" seriesFilter={(series) => series.slice(11, 13)} />
  </Tabs.Tab>
  <Tabs.Tab> 
    | 模型 | qa_1 | qa_2 |
    |------|------|------|
...
<Tabs items={[' 条形图 ', ' 原始数据 ']}>
  <Tabs.Tab> 
      <LineChart name="LongBench-Datas" seriesFilter={(series) => series.slice(0, 4)} />
  </Tabs.Tab>
  <Tabs.Tab> 
...
<Tabs items={[' 条形图 ', ' 原始数据 ']}>
  <Tabs.Tab> 
    <LineChart name="LongBench-Datas" seriesFilter={(series) => series.slice(4, 8)} />
  </Tabs.Tab>
  <Tabs.Tab> 
...
<Tabs items={[' 条形图 ', ' 原始数据 ']}>
  <Tabs.Tab> 
    <LineChart name="LongBench-Datas" seriesFilter={(series) => series.slice(8, 12)} />
  </Tabs.Tab>
  <Tabs.Tab> 
...
<Tabs items={[' 条形图 ', ' 原始数据 ']}>
  <Tabs.Tab> 
    <LineChart name="LongBench-Datas" seriesFilter={(series) => series.slice(12, 16)} />
  </Tabs.Tab>
  <Tabs.Tab> 
...
<Tabs items={[' 条形图 ', ' 原始数据 ']}>
  <Tabs.Tab> 
    <LineChart name="LongBench-Datas" seriesFilter={(series) => series.slice(16, 19)} />
  </Tabs.Tab>
  <Tabs.Tab> 
...
<Tabs items={[' 条形图 ', ' 原始数据 ']}>
  <Tabs.Tab> 
    <LineChart name="LongBench-Datas" seriesFilter={(series) => series.slice(19, 21)} />
  </Tabs.Tab>
  <Tabs.Tab> 
| 模型 | LCC | RepoBench-P |
| --- | --- | --- |
