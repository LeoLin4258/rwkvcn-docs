...
需要参考[准备微调数据集](https://rwkv.cn/RWKV-Fine-Tuning/FT-Dataset)，收集更适合训练 RWKV 的 binidx 数据。

## 配置训练环境

要训练 RWKV 模型，请参考[RWKV 微调环境配置](https://rwkv.cn/RWKV-Fine-Tuning/FT-Environment)板块配置 conda 等训练环境。
...
proj_dir='/home/rwkv/RWKV-PEFT/output_pissa'
