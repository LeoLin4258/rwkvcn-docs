...
![full-ft-simple-cd-rwkv5](./full-ft-simple-cd-rwkv5.png)
...
![ft-dataset-jsonl-landscape](./ft-dataset-jsonl-landscape.png)
...
```
![full-ft-simple-jsonl-to-binidx](./full-ft-simple-jsonl-to-binidx.png)
...
![full-ft-simple-jsonl-to-binidx-2](./full-ft-simple-jsonl-to-binidx-2.png)

## 修改训练参数 

使用任意文本编辑器（如 vscode）打开 `demo-training-run.sh` 文件，可以调整训练参数，进而控制微调的训练过程和训练效果。：

![full-ft-simple-modify-parameters](./full-ft-simple-modify-parameters.png)
...
![full-ft-simple-training-successful](./full-ft-simple-training-successful.png)
