...
![gitclone-json2binidx](./ft-dataset-gitclone-json2binidx.png)
...
![json2binidx-trans-data](./ft-dataset-json2binidx-trans-data.png)

你应该能在 `data `文件夹中找到转换完成的 bin / idx 文件：

![binidx-dataset](./ft-dataset-binidx-dataset.png)
