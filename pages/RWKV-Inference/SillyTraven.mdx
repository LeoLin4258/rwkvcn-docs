---
title: SillyTraven 推理教程 - RWKV推理
description: 本教程将介绍如何使用 SillyTraven 运行 RWKV 模型推理，并与模型聊天对话。
keywords: SillyTraven RWKV,RWKV SillyTraven教程,SillyTraven中使用RWKV模型
---
...
## SillyTraven 下载与安装[#download-and-install]
...
2. 从 SillyTraven Github 仓库的 [Releases](https://github.com/SillyTavern/SillyTavern/releases) 界面下载压缩包
...
SillyTavern 不具备模型推理功能，这里我们使用 [llama.cpp](https://github.com/ggerganov/llama.cpp) 作为 RWKV 模型的推理服务器，并使用 SillyTraven 进行聊天。
