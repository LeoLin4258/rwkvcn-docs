...
![state-file-usage](./ai00-answer-without-state.png)

**挂载“强化单轮中文对话 + Emoji ”的 State 文件后：**

![state-file-usage](./ai00-answer-with-state.png)
...
![state-file-usage](./ai00-state-file-usage.png)

<Callout type="info" emoji="ℹ️">
截至 Ai00 0.5.0 版本，支持在 WebUI-聊天模式右上方动态切换 State，但不支持同时挂载多个 State 。
</Callout>

![ai00-change-state](./ai00-change-state.png)
...
![ai00-LoRA-file-usage](./ai00-LoRA-file-usage.png)
...
![ai00-prefab-export](./ai00-prefab-export.png)
