...
- RWKV 各种模块的 torch 实现：[https://github.com/RWKV/RWKV-block](https://github.com/RWKV/RWKV-block)
- RWKV 官方仓库: [https://github.com/BlinkDL/RWKV-LM](https://github.com/BlinkDL/RWKV-LM)
- [RWKV pip 包](https://pypi.org/project/rwkv/)：RWKV 的 pip 包，具体用法可以查看 [RWKV pip 使用指南](https://rwkv.cn/RWKV-Developer/RWKVpip)
...
- [RWKV_Explained](https://github.com/SmerkyG/RWKV_Explained)：RWKV 的pytorch实现和代码解释
...
### C# 实现
- [RWKVSharp](https://github.com/imxcstar/RWKVSharp/)：使用 C# 封装的 RWKV 模型推理，支持多版本 RWKV 

### 纯 C 语言实现
- [rwkv7.c](https://github.com/ggml-org/llama.cpp/blob/master/convert_hf_to_gguf.py)：使用纯 C 语言实现 RWKV-V7 的推理
...
- **（开发中）**[WorldRWKV](https://github.com/JL-er/WorldRWKV): 使用纯 RWKV7 架构实现任意模态的训练推理

### 图像/图形相关

- [RwkvCompress](https://github.com/sjtu-medialab/RwkvCompress)：基于 RWKV 的图像压缩模型，可以对图像进行高效压缩和重建
...
- [BlackGoose Rimer](https://github.com/Alic-Li/BlackGoose_Rimer)：速度和性能均超越 Transformer 的纯 RWKV 时间序列任务模型
