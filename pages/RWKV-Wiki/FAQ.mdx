...
RWKV-6 的 v2 训练数据集包含以下内容：

![RWKV-v2-dataset-details](./imgs/RWKV-v2-dataset-details.png)

更详细的介绍可以在 [RWKV-6 论文](https://arxiv.org/abs/2404.05892)的 `Training Dataset Details` 板块中找到。
