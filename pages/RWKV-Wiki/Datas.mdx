...
import {MyHeatMap} from '/components/docs/my-heat.tsx'
...
| RWKV-x060-World-7B-v2.1-20240507-ctx4096 | 7.817                  | 10.410      | 8.740    | 8.577             | 8.107                  | 8.248         | 5.122      | 5.516         |
| RWKV-5-World-7B-v2-20240128-ctx4096   | 7.905                  | 10.495      | 8.878    | 8.694             | 8.184                  | 8.311         | 5.187      | 5.587         |
