...
可以从以下链接下载 RWKV State 文件：

- [Hugging Face 主站](https://huggingface.co/BlinkDL/temp-latest-training-models)
- [Hugging Face 镜像站](https://hf-mirror.com/BlinkDL/temp-latest-training-models/tree/main)（国内可访问）
