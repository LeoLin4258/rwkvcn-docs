...
- [RWKV-6-World-v2.1 系列模型的 State 文件](https://huggingface.co/BlinkDL/temp-latest-training-models/tree/main)（Hugging Face 镜像站）
- [RWKV-6-World-v3 系列模型的 State 文件](https://hf-mirror.com/BlinkDL/rwkv-6-misc/tree/main/states)（Hugging Face 镜像站）
