...
+ 出于架构设计，RWKV 模型在**需要回顾的任务**上较弱，因此需要相应地对提示词进行重新排序。
...
RWKV 作为一个开源项目，此前接受了 [Stability AI](https://stability.ai/)、[EleutherAI](https://www.eleuther.ai/) 和其他贡献者提供的大量 GPU 资源和研究支持。
