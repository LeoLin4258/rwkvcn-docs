---
title: 移动端推理性能 - RWKV性能数据
description: RWKV移动端性能数据介绍了RWKV模型在移动端硬件上推理的性能，包括高通、MTK等移动端芯片的性能表现。
keywords: RWKV移动端性能,RWKV手机跑分,RWKV性能测试,RWKV手机性能
---
...
| RWKV v6 3B   | fp16i8    | 13.0599             | 8.9911，71.2206%           |
