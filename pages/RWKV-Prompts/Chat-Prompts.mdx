---
title: 聊天提示词 - RWKV提示词
description: 这个页面展示了多种**聊天模式**的RWKV prompt格式。每个 prompt 示例的右上方有一个复制按钮，可以一键复制 prompt 文本到 RWKV Runner/Ai00 的文本框中粘贴使用。
...
这个页面展示了多种**聊天模式**的 prompt 参考。在每个 prompt 示例的右上方可以一键复制文本，然后到 RWKV Runner/Ai00 的文本框中粘贴使用。
